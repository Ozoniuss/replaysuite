...
type SuiteOptions struct {
	...
	// SkipReplayTest, when true, skips replaying existing histories in
	// HistoriesDir against the current workflow implementations at the start
	// of the suite. New histories generated by the suite are still dumped on
	// tear-down. Defaults to false.
	SkipReplayTest bool
}
