...
- check how dynamic workflows/activities show up in the UI.
...
Available options: `WithReplayWorkflows`, `WithHistoriesDir`, `WithRedactWorkerIdentity`, `WithSkipReplayTest`. See [`suite.go`](./suite.go) for details.
